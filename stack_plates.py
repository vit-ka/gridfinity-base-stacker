...
- What does **not** touch them, all measured and all producing identical support:
  ...
  support blockers.
- Three things do cut it, and all three break the gap interfaces. Do not use
  them: "don't support bridges" (coverage 0.93x -> 0.40x); negative Normal
  Support expansion, which contracts the interface under the narrow lands
  (-0.4 mm -> 0.58x, -1.5 mm -> 0.07x); and tree support in any style, which
  either fills the cells with branches (97 g) or supports the gaps not at all.
